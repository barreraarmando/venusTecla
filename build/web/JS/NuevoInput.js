...
function masMateriales(){
    ...
    micapa.innerHTML+='<input type="text" class="R" placeholder="Material '+cont+'" name="material'+cont+'">';
    document.getElementById("materialoculto").value=cont;
}
function menosMateriales(){
    ...
    micapa.innerHTML='<input type="text" class="R" placeholder="Material 1" name="material1">';
    for(i=1;i<cont;i++){
        micapa.innerHTML+='<input type="text" class="R" placeholder="Material '+(i+1)+'" name="material'+cont+'">';
    }
    document.getElementById("materialoculto").value=cont;
}
function masMultimedia(){
    ...
    micapa.innerHTML+='<span class="iborrainputfile" id="valor"><i class="fa fa-upload subir"></i><p class="nada" id="texto">Seleccionar multimedia</p><input type="file" name="fichero'+cont2+'" accept=".jpg, .jpeg, .png, .mp4" id="imagen" onchange="cambia();" class="inputfile" required=""/></span>';
    document.getElementById("multimediaoculto").value=cont2;
}
